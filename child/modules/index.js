...
var NetworkConnection = /** @class */ (function () {
    ...
    NetworkConnection.prototype.getPort = function (port, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios.post(main_api + "/get-port-info", { port: port, private_key: private_key }, {
                            headers: {
                                "Content-Type": "application/json"
                            }
                        }).then(function (resp) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                return [2 /*return*/, callback(resp.data)];
                            });
                        }); })];
                    case 1:
                        _a.sent();
